...
# 读取CSV文件
vehicle_df = pd.read_csv('train/vehicle_dataset_final.csv', header=0)
...
# 读取CSV文件
cargo_df = pd.read_csv('train/cargo_dataset_final.csv', header=0)
...
vehicle_prior = vcm_change_new.vehicleAttrDis(final_vehicle_queue)
cargo_prior = vcm_change_new.cargoAttrDis(final_cargo_queue)
