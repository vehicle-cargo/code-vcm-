...
vehicle_df = pd.read_csv('dataset/kpca-kpca-data/main_vehicle_cargo_dataset/suiji/v_1.csv', header=None)  # header=None自动添加列字段
cargo_df = pd.read_csv('dataset/kpca-kpca-data/main_vehicle_cargo_dataset/suiji/c_1.csv', header=None)
# 40*6
# print(vehicle_df)
# print(cargo_df)
