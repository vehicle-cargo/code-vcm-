...
# 路程匹配度
def getFlowMatch(a_index, b_index, real_data_dict):
    """
    :param vO: d-vehicle1.csv origin:车辆起始地
    :param vD: d-vehicle1.csv Destination:车辆目的地
    :param cO: d-cargo1.csv origin:货物起始地
    :param cD: d-cargo1.csv Destination:货物目的地
    :return:
    """
    ...
    real_index = int(int(a_index) * 100 + int(b_index))
    cargo_origin_destination = int(real_data_dict[real_index][10])
    vehicle_cargo_origin =int(real_data_dict[real_index][11])
    vehicle_cargo_destination = int(real_data_dict[real_index][12])
...
def timeMatch(vS, vD, cS, cD):
    """
    :param vS: d-vehicle1.csv-start:车辆进入时间
    :param vD: vehicle_deadline:车辆截止时间
    :param cS: d-cargo1.csv-start:货物进入时间
    :param cD: d-cargo1.csv-deadline:货物截止时间
    :return:
    """
    timeMatchDegree = 0
    # vS = 2019050709
...
def vehicleAttrDis(vehicle_queue):
    ...
    for item, value in vehicle_queue.items():
        ...
        # print(type_distri,quality_distri,volume_distri,start_distri,destination_distri,time_distri)
...
def VCM(a, b, real_data_dict, w1=0.16, w2=0.09, w3=0.47, w4=0.28):
    # w1 = 0.2
    # w2 = 0.1
    # w3 = 0.4
    # w4 = 0.3
    ...
    flowMatch = getFlowMatch(a[6], b[6], real_data_dict)
    ...
    # print(typeMatch,qvMatch,flowMatch,timeMatchs,attrMatch)
...
def rePaperVCM(a, b, real_data_dict, w1=0.16, w2=0.09, w3=0.47, w4=0.28):
    # w1 = 0.2
    # w2 = 0.1
    # w3 = 0.4
    # w4 = 0.3
