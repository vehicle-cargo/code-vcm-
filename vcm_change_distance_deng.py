...
vehicle_df = pd.read_csv('new_dataset/kpca_final_data/deng/v6.csv', header=None)  # header=None自动添加列字段
cargo_df = pd.read_csv('new_dataset/kpca_final_data/deng/c6.csv', header=None)
# 40*6
# print(vehicle_df)
# print(cargo_df)
