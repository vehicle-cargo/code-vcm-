...
vehicle_df = pd.read_csv('new_dataset/kpca_final_data/kbr/vehicle_dataset_final.csv',
                         header=None)  # header=None自动添加列字段
cargo_df = pd.read_csv('new_dataset/kpca_final_data/kbr/cargo_dataset_final.csv', header=None)
# 40*6
# print(vehicle_df)
# print(cargo_df)
...
for t in time:
    ...
    for success in success_queue:  # 匹配成功的队列
        ...
        if success[2] not in degree_num_list:
